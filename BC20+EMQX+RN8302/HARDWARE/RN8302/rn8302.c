...
float Ki = 1.19448E-07;
float Kp = 1.18491E-05;
unsigned int   EC        = 6400;
unsigned short HFConst   = 5659;
...
unsigned short uPA_PHSL  = 0x77;
unsigned short uPB_PHSL  = 0x77;
unsigned short uPC_PHSL  = 0x77;
unsigned short uQA_PHSL  = 0x77;
unsigned short uQB_PHSL  = 0x77;
unsigned short uQC_PHSL  = 0x77;
