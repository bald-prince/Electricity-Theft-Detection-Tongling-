...
void GPIO_INIT(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC | RCC_APB2Periph_AFIO | RCC_APB2Periph_GPIOA,ENABLE);	//打开GPIO使能时钟，先开复用功能
	...
	GPIO_Init(GPIOC, &GPIO_InitStructure);	  				 //初始化PB口
	//PB5 PB4 PB3
	GPIO_SetBits(GPIOC,GPIO_Pin_13); 	//关闭灯
